...
export default function SanityConfigModal({ isOpen, onClose, onConfigSave }: SanityConfigModalProps) {
  ...
  fields: [
    ...
    { name: 'heroBrandingTitle', type: 'string', title: 'Hero Card 1 (Branding) Title override (e.g. BRANDING YANG DIPERCAYA)' },
    { name: 'heroBrandingImage', type: 'image', title: 'Hero Card 1 (Branding) Image override (Upload Image)', options: { hotspot: true } },
    { name: 'heroApparelTitle', type: 'string', title: 'Hero Card 2 (Apparel) Title override (e.g. DESAIN UNTUK IDENTITAS TIM)' },
    { name: 'heroApparelImage', type: 'image', title: 'Hero Card 2 (Apparel) Image override (Upload Image)', options: { hotspot: true } },
    { name: 'heroWebTitle', type: 'string', title: 'Hero Card 3 (Web Dev) Title override (e.g. WEBSITE DENGAN LOAD CEPAT)' },
    { name: 'heroWebImage', type: 'image', title: 'Hero Card 3 (Web Dev) Image override (Upload Image)', options: { hotspot: true } },
